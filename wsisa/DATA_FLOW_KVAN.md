...
| MySQL `kvan_links`, `kvan_transactions` | U-PAY 원천·삭제 등 |
...
「결제 및 취소 내역」「결제 링크 관리」는 U-PAY **웹 URL**이 아니라 **DB에 반영된 스냅샷**이므로, 크롤 한 사이클이 끝난 뒤 다시 새로고침하면 최신에 가깝게 보인다.
